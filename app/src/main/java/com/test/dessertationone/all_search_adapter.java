...
public class all_search_adapter extends ArrayAdapter<all_search> {
    RequestQueue queue;
    RequestQueue queue2;
    ArrayList<all_search> products;
    Context context;
    int resource;


    public all_search_adapter(Context context, int resource, ArrayList<all_search> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.all_search_layout, null, true);

        }
        all_search product = getItem(position);
