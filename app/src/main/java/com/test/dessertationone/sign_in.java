...
public class sign_in extends AppCompatActivity {
    ...
    RequestQueue queue;
    Button delivered,gotosignup2,forgot_password;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent a = new Intent(sign_in.this,forgot_password1.class);
                startActivity(a);
        ...
        gotosignup2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(sign_in.this,create_account.class);
                startActivity(a);
                ...
                try {
                    ...
                    if (obj.getString("status").equals("ok")) {
                        ...
                        delivered.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent i = new Intent(sign_in.this, create_account.class);
                                startActivity(i);
                                finish();
                            }
                        });
